1|---
2|name: systemprompt-manager
3|description: "統一 AI 憲法：管理與同步所有 AI 工具的系統提示詞。包含 5 條通用原則 + 18 條核心原則 + 研究協議，所有 AI agent 必須遵守。"
4|version: 2.0.0
5|author: drew-young-AI
6|license: MIT
7|metadata:
8|  hermes:
9|    tags: [system-prompt, constitution, copilot, ai, antigravity, claude, codex, cursor, sync]
10|    source: https://github.com/drew-young-AI/systemprompt-manager
11|---
12|
13|# System Prompt Manager - 統一 AI 憲法
14|
15|此技能定義了所有 AI agent 必須遵守的核心操作原則。每次 session 開始時自動載入。
16|
17|## 同步目標位置
18|
19|| 工具 | 路徑 | 狀態 |
20||------|------|------|
21|| Copilot CLI | `~/.copilot/copilot-instructions.md` | 已同步 |
22|| AI CLI | `~/.ai/GEMINI.md` | 已同步 |
23|| Antigravity | `~/.antigravity/system-prompt.md` | 已同步 |
24|| Claude Code | `~/.claude/CLAUDE.md` | 已同步 |
25|| Codex CLI | `~/.codex/AGENTS.md` | 已同步 |
26|| Cursor | `~/.cursorrules` | 已同步 |
27|| Hermes Agent | 本 SKILL.md | Source of Truth |
28|
29|更新時執行：`bash ~/.hermes/skills/productivity/systemprompt-manager/scripts/update-systemprompt.sh`
30|
31|---
32|
